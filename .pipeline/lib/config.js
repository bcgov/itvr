...
const phases = {
  ...
  dev: {namespace:'ac294c-dev', transient:true, name: `${name}`, ssoSuffix:'-dev', 
        ...
        backendCpuRequest: '20m', backendCpuLimit: '60m', backendMemoryRequest: '60Mi', backendMemoryLimit: '120Mi', backendHealthCheckDelay: 30, backendHost: `itvr-backend-dev-${changeId}.${ocpName}.gov.bc.ca`, backendReplicas: 1,
  ...
  test: {namespace:'ac294c-test', name: `${name}`, ssoSuffix:'-test', 
        ...
        metabaseCpuRequest: '200m', metabaseCpuLimit: '300m', metabaseMemoryRequest: '500Mi', metabaseMemoryLimit: '2Gi', metabaseReplicas: 1,
        frontendCpuRequest: '70m', frontendCpuLimit: '210m', frontendMemoryRequest: '300Mi', frontendMemoryLimit: '600Mi', frontendReplicas: 1, frontendMinReplicas: 1, frontendMaxReplicas: 3,
        backendCpuRequest: '20m', backendCpuLimit: '60m', backendMemoryRequest: '60Mi', backendMemoryLimit: '120Mi', backendHealthCheckDelay: 30, backendReplicas: 1, backendMinReplicas: 1, backendMaxReplicas: 3, backendHost: `itvr-backend-test.${ocpName}.gov.bc.ca`,
