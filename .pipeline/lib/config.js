...
const phases = {
  ...
  test: {namespace:'ac294c-test', name: `${name}`, ssoSuffix:'-test', 
        ...
        backendCpuRequest: '20m', backendCpuLimit: '60m', backendMemoryRequest: '60Mi', backendMemoryLimit: '120Mi', backendHealthCheckDelay: 30, backendReplicas: 2, backendMinReplicas: 1, backendMaxReplicas: 3, backendHost: `itvr-backend-test.${ocpName}.gov.bc.ca`,
