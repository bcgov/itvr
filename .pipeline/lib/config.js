...
const phases = {
  ...
  dev: {namespace:'ac294c-dev', transient:true, name: `${name}`, ssoSuffix:'-dev', 
        ...
        backendCpuRequest: '50m', backendCpuLimit: '100m', backendMemoryRequest: '520Mi', backendMemoryLimit: '1Gi', backendHealthCheckDelay: 30, backendHost: `-backend-dev-${changeId}.${ocpName}.gov.bc.ca`, backendReplicas: 1,
  ...
  test: {namespace:'ac294c-test', name: `${name}`, ssoSuffix:'-test', 
        ...
        backendCpuRequest: '50m', backendCpuLimit: '100m', backendMemoryRequest: '520Mi', backendMemoryLimit: '1Gi', backendHealthCheckDelay: 30, backendReplicas: 1, backendMinReplicas: 1, backendMaxReplicas: 3, backendHost: `ctitvrhub-backend-test.${ocpName}.gov.bc.ca`,
  ...
  prod: {namespace:'ac294c-prod', name: `${name}`, ssoSuffix:'', 
        ...
        frontendCpuRequest: '400m', frontendCpuLimit: '800m', frontendMemoryRequest: '600Mi', frontendMemoryLimit: '1200Mi', frontendReplicas: 1, frontendMinReplicas: 1, frontendMaxReplicas: 3,
        backendCpuRequest: '50m', backendCpuLimit: '100m', backendMemoryRequest: '520Mi', backendMemoryLimit: '1Gi', backendHealthCheckDelay: 30, backendReplicas: 1, backendMinReplicas: 1, backendMaxReplicas: 3, backendHost: `citvrthub-backend-prod.${ocpName}.gov.bc.ca`,
        minioCpuRequest: '30m', minioCpuLimit: '100m', minioMemoryRequest: '150Mi', minioMemoryLimit: '300Mi', minioPvcSize: '3G',
