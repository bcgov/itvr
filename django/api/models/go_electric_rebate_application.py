...
class GoElectricRebateApplication(TimeStampedModel):
    ...
    class Status(TextChoices):
        ...
        NOT_APPROVED_HIGH_INCOME = ("not_approved_high_income", _("Not Approved - High Income"))
        NOT_APPROVED_NO_CRA_INFO = ("not_approved_no_cra_info", _("Not Approved - No CRA Info"))
